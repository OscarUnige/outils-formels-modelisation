...
public enum Formula {
    ...
    public var dnf: Formula {
        //On prend la forme nnf de la formule donnée
        let form = self.nnf
        //On transforme cette forme nnf en dnf comme vu en cours
        switch form {
        case .proposition(_):
            return self
    ...
    public var cnf: Formula {
        //Comme avant mais cette fois on veut la forme conjonctive
        let form = self.nnf
        switch form {
        case .proposition(_):
            return self
